    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                <h2>Tambah Data Perkawinan</h2>
            </div>
            <div class="card-body">
                <form>
                    <div class="mb-3">
                        <label for="noKK" class="form-label">Perkawinan</label>
                        <input type="text" class="form-control" id="noKK" placeholder="Perkawinan">
                    </div>
