...
<body>
    <div class="container-fluid p-0">
        ...
        <!-- Content -->
        <div class="container">
            <h1 class="text-black">Layanan</h1>
            <div class="d-flex mb-3">
                <a class="btn btn-add me-2" href="/tambahagama">Tambah</a>
            ...
            <div class="table-container">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Pembuatan E-KTP</td>
                            <td>Layanan untuk pembuatan E-Ktp</td>
                            <td> Akta Kelahiran, Kartu Keluarga, Pas Foto 3X4</td>
                            <td>
