    ...
    <div class="container">
        <div class="card mt-5">
            ...
            <div class="card-body">
                <form>
                    <div class="mb-3">
                        <label for="noKK" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="noKK" placeholder="Nama">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="rt" class="form-label">Kecamatan</label>
                        <input type="text" class="form-control" id="rt" placeholder="Kecamatan">
                    </div>
                    <div class="mb-3">
                        <label for="rw" class="form-label">Kabupaten</label>
                        <input type="text" class="form-control" id="rw" placeholder="Kabupaten">
                    </div>
                    <div class="mb-3">
                        <label for="kodePos" class="form-label">Provinsi</label>
                        <input type="text" class="form-control" id="kodePos" placeholder="Provinsi">
                    </div>
